...
export default function Navigation_bar() {
  ...
  const getLinkClasses = (path, isButton = false, isMobile = false) => {
    ...
    return isActiveLink(path) 
      ? `${baseClasses} text-white bg-white/20 shadow-lg ${!isMobile ? 'before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/10 before:to-transparent before:-translate-x-full hover:before:translate-x-full before:transition-transform before:duration-700' : ''}`
      : `${baseClasses} text-green-50 hover:text-white hover:bg-white/10 ${!isMobile ? 'before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/10 before:to-transparent before:-translate-x-full hover:before:translate-x-full before:transition-transform before:duration-700' : ''}`;
  };
  ...
  return (
    <nav className="bg-gradient-to-r from-green-600 via-green-600 to-green-700 text-white shadow-xl sticky top-0 z-50 border-b border-green-500/30">
          ...
          <div className="lg:hidden">
            ...
            >
              ...
              <div className="relative w-6 h-6">
                {!isMenuOpen ? (
                  <svg className="block w-6 h-6 transform transition-transform duration-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16" />
                  </svg>
                ) : (
                  <svg className="block w-6 h-6 transform rotate-180 transition-transform duration-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
      ...
      <div className={`lg:hidden transition-all duration-500 ease-in-out ${isMenuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
